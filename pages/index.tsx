...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Canadian Mobile Welding | Trusted Welding Services in Toronto & GTA</title>
        <meta name="description" content="Canadian Mobile Welding offers professional mobile and in-shop welding services for industrial, commercial, and residential projects in Toronto and the GTA." />
        <meta name="keywords" content="mobile welding, welding services, Toronto welding, GTA welding, industrial welding, commercial welding, residential welding" />
      </Head>
                ...
                <div className="flex justify-center mt-6 space-x-2">
                  {reviews.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-colors ${index === currentReview ? 'bg-brand-red' : 'bg-gray-300'
                        }`}
